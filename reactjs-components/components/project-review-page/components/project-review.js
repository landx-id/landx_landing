            ...
            <div className="col-lg-6 col-md-12 col-sm-12 deskripsi-review">
                ...
                <div id="as">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-12" id="biru">
                        <a href={'http://sendy.landx.id/subscription?f=7MlPrs1pHK3LfJpBLI1sWShWyK3Xk7Z4SEPV9wlXzQ4pslSRKeKURXQ6kzpt763NN33JFc35AS73709XS4P8mXqQ'} className="btn btn-light" id="remaind">
